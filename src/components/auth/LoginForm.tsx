  ...
  return (
    <div className="space-y-6">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-50 text-gray-900 font-medium rounded-lg transition-colors relative overflow-hidden group"
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-black/[0.05] opacity-0 group-hover:opacity-100 transition-opacity" />
      </button>
